...
%     if (position_start_add(1)<position_destination_add(1))%起点在终点右边
%         
%     else%起点在终点左边
...
%                 vertices=[vertices,position_start_add'];
%                 flag_change1=1; %起点在终点左边的标记
%             else
%                 position_destination_add=obstacle_point(:,i+1)'-[300,400];%由终点向起点走,先取中间两个点再加两端
%                 vertices=[vertices,position_destination_add'];
% %                 flag_change2=1; %起点在终点右边的标记
